...
lazy_static! {
    ...
    pub static ref DUMMY_LOCK_HASH: [u8; 32] = calc_data_hash(&DUMMY_LOCK_BIN).unpack();
    pub static ref MAIN_CONTRACT_HASH: [u8; 32] = calc_data_hash(&MAIN_CONTRACT_BIN).unpack();
}
