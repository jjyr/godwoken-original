...
int verify_deposit(mol_seg_t *old_global_state_seg,
  ...
  mol_seg_t old_index_seg = MolReader_AccountEntry_get_index(&old_entry_seg);
  ...
  mol_seg_t new_pubkey_hash_seg =
      MolReader_AccountEntry_get_pubkey_hash(&new_entry_seg);
  ...
  mol_seg_t new_balance_seg =
      MolReader_AccountEntry_get_balance(&new_entry_seg);
