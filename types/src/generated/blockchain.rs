...
impl molecule::prelude::Builder for BytesOptBuilder {
    ...
    fn write_buf<B: molecule::bytes::BufMut>(&self, buf: &mut B) {
        self.0
            .as_ref()
            .map(|ref inner| buf.put_slice(inner.as_slice()));
    }
    fn build(&self) -> Self::Entity {
        let mut inner = Vec::with_capacity(self.expected_length());
        self.write_buf(&mut inner);
...
impl molecule::prelude::Builder for BytesVecBuilder {
    ...
    fn write_buf<B: molecule::bytes::BufMut>(&self, buf: &mut B) {
        ...
        if item_count == 0 {
            buf.put_slice(&molecule::pack_number(
...
impl molecule::prelude::Builder for ScriptBuilder {
    ...
    fn write_buf<B: molecule::bytes::BufMut>(&self, buf: &mut B) {
        ...
        buf.put_slice(self.hash_type.as_slice());
        buf.put_slice(self.args.as_slice());
    }
    fn build(&self) -> Self::Entity {
        let mut inner = Vec::with_capacity(self.expected_length());
        self.write_buf(&mut inner);
...
impl molecule::prelude::Builder for CellInputBuilder {
    ...
    fn write_buf<B: molecule::bytes::BufMut>(&self, buf: &mut B) {
        buf.put_slice(self.since.as_slice());
        buf.put_slice(self.previous_output.as_slice());
    }
    fn build(&self) -> Self::Entity {
        let mut inner = Vec::with_capacity(self.expected_length());
        self.write_buf(&mut inner);
...
impl molecule::prelude::Builder for CellOutputBuilder {
    ...
    fn write_buf<B: molecule::bytes::BufMut>(&self, buf: &mut B) {
        ...
        buf.put_slice(self.capacity.as_slice());
        buf.put_slice(self.lock.as_slice());
        buf.put_slice(self.type_.as_slice());
    }
    fn build(&self) -> Self::Entity {
        let mut inner = Vec::with_capacity(self.expected_length());
        self.write_buf(&mut inner);
...
impl molecule::prelude::Builder for CellDepBuilder {
    ...
    fn write_buf<B: molecule::bytes::BufMut>(&self, buf: &mut B) {
        buf.put_slice(self.out_point.as_slice());
        buf.put_slice(self.dep_type.as_slice());
    }
    fn build(&self) -> Self::Entity {
        let mut inner = Vec::with_capacity(self.expected_length());
        self.write_buf(&mut inner);
...
impl molecule::prelude::Builder for RawTransactionBuilder {
    ...
    fn write_buf<B: molecule::bytes::BufMut>(&self, buf: &mut B) {
        ...
        buf.put_slice(self.version.as_slice());
        buf.put_slice(self.cell_deps.as_slice());
        buf.put_slice(self.header_deps.as_slice());
        buf.put_slice(self.inputs.as_slice());
        buf.put_slice(self.outputs.as_slice());
        buf.put_slice(self.outputs_data.as_slice());
    }
    fn build(&self) -> Self::Entity {
        let mut inner = Vec::with_capacity(self.expected_length());
        self.write_buf(&mut inner);
...
impl molecule::prelude::Builder for TransactionBuilder {
    ...
    fn write_buf<B: molecule::bytes::BufMut>(&self, buf: &mut B) {
        ...
        buf.put_slice(self.raw.as_slice());
        buf.put_slice(self.witnesses.as_slice());
    }
    fn build(&self) -> Self::Entity {
        let mut inner = Vec::with_capacity(self.expected_length());
        self.write_buf(&mut inner);
...
impl molecule::prelude::Builder for RawHeaderBuilder {
    ...
    fn write_buf<B: molecule::bytes::BufMut>(&self, buf: &mut B) {
        buf.put_slice(self.version.as_slice());
        buf.put_slice(self.compact_target.as_slice());
        buf.put_slice(self.timestamp.as_slice());
        buf.put_slice(self.number.as_slice());
        buf.put_slice(self.epoch.as_slice());
        buf.put_slice(self.parent_hash.as_slice());
        buf.put_slice(self.transactions_root.as_slice());
        buf.put_slice(self.proposals_hash.as_slice());
        buf.put_slice(self.uncles_hash.as_slice());
        buf.put_slice(self.dao.as_slice());
    }
    fn build(&self) -> Self::Entity {
        let mut inner = Vec::with_capacity(self.expected_length());
        self.write_buf(&mut inner);
...
impl molecule::prelude::Builder for UncleBlockBuilder {
    ...
    fn write_buf<B: molecule::bytes::BufMut>(&self, buf: &mut B) {
        ...
        buf.put_slice(self.proposals.as_slice());
    }
    fn build(&self) -> Self::Entity {
        let mut inner = Vec::with_capacity(self.expected_length());
        self.write_buf(&mut inner);
...
impl molecule::prelude::Builder for BlockBuilder {
    ...
    fn write_buf<B: molecule::bytes::BufMut>(&self, buf: &mut B) {
        ...
        buf.put_slice(self.header.as_slice());
        buf.put_slice(self.uncles.as_slice());
        buf.put_slice(self.transactions.as_slice());
        buf.put_slice(self.proposals.as_slice());
    }
    fn build(&self) -> Self::Entity {
        let mut inner = Vec::with_capacity(self.expected_length());
...
impl molecule::prelude::Builder for CellbaseWitnessBuilder {
    ...
    fn write_buf<B: molecule::bytes::BufMut>(&self, buf: &mut B) {
        ...
        buf.put_slice(self.lock.as_slice());
        buf.put_slice(self.message.as_slice());
    }
    fn build(&self) -> Self::Entity {
        let mut inner = Vec::with_capacity(self.expected_length());
        self.write_buf(&mut inner);
...
impl molecule::prelude::Builder for WitnessArgsBuilder {
    ...
    fn write_buf<B: molecule::bytes::BufMut>(&self, buf: &mut B) {
        ...
        buf.put_slice(self.lock.as_slice());
        buf.put_slice(self.input_type.as_slice());
        buf.put_slice(self.output_type.as_slice());
    }
    fn build(&self) -> Self::Entity {
        let mut inner = Vec::with_capacity(self.expected_length());
        self.write_buf(&mut inner);
